...
#    
#    
#    Version Created: 1.0, 11th of Mach, 2019
#    Version Updated (IF and ELSEIF): 1.1, 14th of March, 2019
#    Version Updated configure (DelegateWastebasketStyle): 1.2, 25th of March, 2019
